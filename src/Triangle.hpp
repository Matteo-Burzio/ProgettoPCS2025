...
// Functions which checks if the new vertex already exists (Triangle.cpp)
unsigned int addVertexIfMissing(Polyhedron& P, const Vector3d coords_V);

// Functions which checks if the new edge already exists and add it to P(Triangle.cpp)
